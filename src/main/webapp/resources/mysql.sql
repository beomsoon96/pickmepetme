...
alter table comunity add (comunity_id char(1) not null DEFAULT 1);
...
alter table tip_comunity add (comunity_id char(1) not null DEFAULT 2);
...
alter table care_comunity add (comunity_id char(1) not null DEFAULT 3);

select * from care_comunity
drop table care_comunity

desc care_comunity
alter table care_comunity modify column hit int default 0 after gdsImg;
...
alter table sitter_comunity add (comunity_id char(1) not null DEFAULT 4);

desc sitter_comunity
alter table sitter_comunity modify column hit int default 0 after gdsImg;
<--! 외래키 설정-->
...
alter table parcel_comunity add(Hit int Default 0);
alter table parcel_comunity add (gdsThumbImg varchar(200));
alter table parcel_comunity add (gdsImg varchar(200));
...
alter table parcel_comunity modify column hit int default 0 after gdsImg;
